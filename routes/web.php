...
// =======================
Route::prefix('jual')->name('produk.')->group(function () {
...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/dashboard/chart-data', [AdminDashboardController::class, 'chartData'])->name('dashboard.chart-data'); // Perbaiki: AdminDashboardController
    Route::get('/dashboard/quick-stats', [AdminDashboardController::class, 'quickStats'])->name('dashboard.quick-stats'); // Perbaiki: AdminDashboardController
    Route::get('/dashboard/export', [AdminDashboardController::class, 'export'])->name('dashboard.export'); // Perbaiki: AdminDashboardController
    ...
    // Sewa langsung (tanpa keranjang)
    Route::post('/sewa/direct/{produk}', [CheckoutController::class, 'directSewa'])->name('sewa.direct');
    ...
    Route::get('kategori', [AdminKategoriController::class, 'index'])->name('kategori.index'); // Sesuaikan dengan resource
...
Route::middleware(['auth'])->prefix('user')->name('user.')->group(function () {
    ...
    Route::prefix('sewa')->name('sewa.')->group(function () {
        ...
        Route::get('/struk', [SewaController::class, 'struk'])->name('struk');
        Route::get('/{id}', [SewaController::class, 'show'])->name('show');

        // Pastikan route pengembalian dan calculate denda dalam prefix yang sama
        Route::post('/calculate-denda', [SewaController::class, 'calculateDenda'])
            ->name('calculate-denda');
        Route::post('/{id}/pengembalian', [SewaController::class, 'pengembalian'])
            ->name('pengembalian');
