...
<body class="gradient-bg min-h-screen flex items-center justify-center p-4">
                ...
                <div class="p-6">
                    <div class="flex items-start">
                        <div class="flex-shrink-0">
                            <div
                                class="w-12 h-12 rounded-full bg-gradient-to-r from-green-400 to-emerald-500 flex items-center justify-center">
    ...
    <div class="relative w-full max-w-6xl flex flex-col md:flex-row rounded-3xl overflow-hidden shadow-2xl">
        ...
        <div
            class="hidden md:flex md:w-1/2 bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800 p-12 flex-col justify-between text-white relative overflow-hidden">
            <!-- Background pattern -->
            <div class="absolute inset-0 opacity-10">
                ...
                <div
                    class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-24 h-24 rounded-full bg-white">
                </div>
            </div>
            ...
            <div class="relative z-10">
                <div class="flex items-center space-x-2 mb-8">
                    <div
                        class="w-10 h-10 rounded-full bg-gradient-to-r from-pink-500 to-orange-500 flex items-center justify-center">
                ...
                <p class="text-lg opacity-90 mb-10">Temukan koleksi terbaru untuk mendukung aktivitas olahraga dan gaya
                    hidup sehat Anda.</p>
            </div>
            ...
            <div
                class="absolute -bottom-4 -right-4 w-48 h-48 bg-gradient-to-r from-pink-500 to-yellow-500 rounded-full opacity-20 floating-animation">
            </div>
        </div>
        ...
        <div class="w-full md:w-1/2 glass-card p-8 md:p-12">
            ...
            @if ($errors->any())
                <div
                    class="mb-6 p-4 rounded-xl bg-gradient-to-r from-red-50 to-pink-50 border border-red-200 text-red-700">
            ...
            <form method="POST" action="{{ route('login') }}" id="loginForm">
                ...
                <!-- Tombol Login -->
                <button type="submit"
                    class="btn-login w-full py-3.5 px-4 rounded-xl text-white font-semibold shadow-lg mb-6">
                ...
                <div class="text-center pt-6 border-t border-gray-200">
                    <p class="text-gray-600">
                        ...
                        <a href="{{ route('register') }}"
                            class="font-semibold text-indigo-600 hover:text-indigo-800 ml-1">
                            Daftar sekarang
                        </a>
                    </p>
                </div>
    ...
    @if (session('success'))
        <div x-data="{ show: true }" x-init="setTimeout(() => show = false, 5000)" x-show="show" x-transition
            ...
            <div
                class="flex items-start gap-3 bg-green-100 text-green-500 px-4 py-3 rounded-lg shadow-lg min-w-[280px]">

                <div class="flex-1 text-sm font-medium">
                    {{ session('success') }}
                </div>

                <button @click="show = false" class=" text-lg leading-none" aria-label="Close">
                    &times;
                </button>
