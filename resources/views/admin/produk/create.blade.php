                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <select name="tipe" required id="tipe"
                                            ...
                                            <option value="jual" {{ old('tipe') == 'jual' ? 'selected' : '' }}>Jual
                                            </option>
                                            <option value="sewa" {{ old('tipe') == 'sewa' ? 'selected' : '' }}>Sewa
                                            </option>
                                            <option value="both" {{ old('tipe') == 'both' ? 'selected' : '' }}>Jual & Sewa
                                            </option>
                                        </select>
                                        <div
                                            class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-300">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="stok_total" required min="0"
                                        class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-primary/50 focus:border-primary transition duration-200"
                                        value="{{ old('stok_total', 0) }}" oninput="updateAvailableStock()">
                                ...
                                <div id="stok-disewa-group" class="hidden">
                                    ...
                                    <div class="relative">
                                        <input type="number" name="stok_disewa" min="0" id="stok_disewa"
                                            class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-primary/50 focus:border-primary transition duration-200"
                                            value="{{ old('stok_disewa', 0) }}" oninput="validateDisewaStock()">
                                        <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                                            <span class="text-gray-500">unit</span>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" name="harga_sewa_harian" min="0"
                                            class="w-full border border-gray-300 rounded-lg pl-10 pr-4 py-3 focus:ring-2 focus:ring-primary/50 focus:border-primary transition duration-200"
                                            value="{{ old('harga_sewa_harian') }}" placeholder="0">
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="number" name="harga_sewa_mingguan" min="0"
                                                class="w-full border border-gray-300 rounded-lg pl-10 pr-4 py-3 focus:ring-2 focus:ring-primary/50 focus:border-primary transition duration-200"
                                                value="{{ old('harga_sewa_mingguan') }}" placeholder="0">
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="number" name="harga_sewa_bulanan" min="0"
                                                class="w-full border border-gray-300 rounded-lg pl-10 pr-4 py-3 focus:ring-2 focus:ring-primary/50 focus:border-primary transition duration-200"
                                                value="{{ old('harga_sewa_bulanan') }}" placeholder="0">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <p class="mt-2 text-sm text-white">
                                Total stok varian: <span id="totalVarian">0</span>
                            </p>
                        </div>
                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('produk-form').addEventListener('submit', function(e) {
                ...
                if (tipe === 'jual' && (!hargaBeli.value || hargaBeli.value <= 0)) {
                    ...
                    hargaSewa.focus();
                } else if (tipe === 'both' && ((!hargaBeli.value || hargaBeli.value <= 0) || (!hargaSewa
                        .value || hargaSewa.value <= 0))) {
                    e.preventDefault();
