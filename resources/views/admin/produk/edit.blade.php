                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="nama" required
                                    ...
                                    value="{{ old('nama', $produk->nama) }}" placeholder="Masukkan nama produk">
                                @error('nama')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <select name="kategori_id" required style="color: #111; background-color: #fff;"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <select name="tipe" required id="tipe"
                                            ...
                                            <option value="jual"
                                                {{ old('tipe', $produk->tipe) == 'jual' ? 'selected' : '' }}>Jual</option>
                                            <option value="sewa"
                                                {{ old('tipe', $produk->tipe) == 'sewa' ? 'selected' : '' }}>Sewa</option>
                                            <option value="both"
                                                {{ old('tipe', $produk->tipe) == 'both' ? 'selected' : '' }}>Jual & Sewa
                                            </option>
                                        </select>
                                        <div
                                            class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-100">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div id="stock-fields" class="space-y-4">
                                ...
                                <div id="stok-disewa-group"
                                    class="{{ in_array($produk->tipe, ['sewa', 'both']) ? '' : 'hidden' }}">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <div id="price-fields" class="space-y-4">
                            <!-- Harga Beli -->
                            <div id="harga-beli-group"
                                class="{{ in_array($produk->tipe, ['jual', 'both']) ? '' : 'hidden' }}">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="harga_beli" min="0"
                                        ...
                                        value="{{ old('harga_beli', $produk->harga_beli) }}" placeholder="0">
                                </div>
                                @error('harga_beli')
                                    <p class="mt-2 text-sm text-red-600 flex items-center">
                                        <i class="fas fa-exclamation-circle mr-1"></i> {{ $message }}
                            ...
                            <!-- Harga Sewa -->
                            <div id="harga-sewa-group"
                                class="{{ in_array($produk->tipe, ['sewa', 'both']) ? 'space-y-4' : 'hidden' }}">
                                <!-- Harga Sewa Harian -->
                                <div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <div class="space-y-6">
                            <!-- Warna -->
                            <label class="block text-sm font-medium text-gray-300 mb-3">Varian Produk</label>

                            <table class="w-full border" id="varianTable">
                                <thead>
                                ...
                                <tbody id="counting">
                                    @forelse ($produk->varians as $item)    
                                        <tr>
                                            <td><input type="text" name="varians[{{$loop->iteration-1}}][warna]" value="{{$item->warna}}"
                                                    class="border px-2 py-1 w-full"></td>
                                            <td><input type="text" name="varians[{{$loop->iteration-1}}][size]" value="{{$item->size}}"
                                                    class="border px-2 py-1 w-full"></td>
                                            <td><input type="number" name="varians[{{$loop->iteration-1}}][stok]" min="0" value="{{$item->stok}}"
                                                    class="border px-2 py-1 w-full varian-stok"></td>
                                            <td><button type="button" class=" w-8 h-8 bg-red-500 text-white" onclick="removeRow(this)">✕</button></td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td><input type="text" name="varians[0][warna]"
                                                    class="border px-2 py-1 w-full"></td>
                                            <td><input type="text" name="varians[0][size]"
                                                    class="border px-2 py-1 w-full"></td>
                                            <td><input type="number" name="varians[0[stok]" min="0"
                                                    class="border px-2 py-1 w-full varian-stok"></td>
                                            <td><button type="button" class=" w-8 h-8 bg-red-500 text-white" onclick="removeRow(this)">✕</button></td>
                                        </tr>
                                    @endforelse
                            ...
                            <p class="mt-2 text-sm text-white">
                                Total stok varian: <span id="totalVarian">{{$produk->varians->sum('stok')}}</span>
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                @if ($produk->gambarTambahan?->count() > 0)
                                    <div class="space-y-4 mb-4">
                                        @foreach ($produk->gambarTambahan as $img)
                                            <div
                                                class="relative group bg-gray-800/50 rounded-xl overflow-hidden border-2 border-gray-700 hover:border-gray-600 transition">
                                                ...
                                                <div class="relative w-full" style="padding-bottom: 56.25%;">
                                                    ...
                                                    @if ($img->is_primary)
                                                        <div class="absolute top-4 left-4">
                                                            <span
                                                                class="bg-blue-500 text-white text-sm px-3 py-1.5 rounded-lg shadow-lg font-medium flex items-center gap-2">
                                                    ...
                                                    <div
                                                        class="delete-overlay-{{ $img->id }} absolute inset-0 bg-red-500 bg-opacity-0 transition-all duration-300 pointer-events-none flex items-center justify-center">
                                    ...
                                    <div class="bg-blue-500/10 border border-blue-500/30 rounded-lg p-3 mb-4">
                                        <p class="text-sm text-blue-300 flex items-center gap-2">
                                            ...
                                            <span>Tandai gambar yang ingin dihapus dengan checkbox, lalu klik tombol
                                                <strong>Simpan Perubahan</strong> di bawah untuk menghapus gambar.</span>
                                        </p>
                                    </div>
                                @elseif($produk->gambar)
                                    <!-- Legacy single image fallback -->
                                    <div class="mb-4">
                                        <div class="relative w-full bg-gray-800/50 rounded-xl overflow-hidden border-2 border-gray-700"
                                        ...
                                        <div class="mt-3 p-3 bg-yellow-500/10 border border-yellow-500/30 rounded-lg">
                                            <p class="text-xs text-yellow-300 flex items-center gap-2">
                                                ...
                                                Gambar lama (format single image). Upload gambar baru untuk menggunakan
                                                multiple image.
                                            </p>
                                        </div>
                                    </div>
                                @else
                                    <!-- No image -->
                                    <div class="mb-4">
                                        <div class="relative w-full bg-gray-800/50 rounded-xl overflow-hidden border-2 border-dashed border-gray-600"
                                            style="padding-bottom: 56.25%;">
                                ...
                                <div class="relative">
                                    <input type="file" name="gambar[]" id="gambar"
                                        accept="image/png, image/jpg, image/jpeg" class="hidden" multiple
                                        onchange="previewMultipleImages(event)">
                                    <label for="gambar" class="cursor-pointer">
                                        <div
                                            class="border-2 border-dashed border-gray-600 rounded-xl p-8 text-center hover:border-primary/50 hover:bg-gray-800/30 transition duration-200">
                                            <div id="image-previews" class="space-y-4 mb-6 hidden"></div>
                                            <div id="upload-placeholder">
                                                <i class="fas fa-cloud-upload-alt text-5xl text-gray-400 mb-4"></i>
                                                <p class="text-base text-gray-300 mb-2 font-medium">Klik untuk tambah
                                                    gambar baru</p>
                                                <p class="text-sm text-gray-500">Max: 2MB per file, Format: JPG, PNG, JPEG
                                                </p>
                                                <p class="text-sm text-gray-500 mt-1">Bisa upload beberapa gambar sekaligus
                                                </p>
                                            </div>
                                        </div>
                                    </label>
                            ...
                            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                                ...
                                <div class="relative">
                                    <input type="checkbox" name="is_active" value="1" id="is_active"
                                        {{ old('is_active', $produk->is_active) ? 'checked' : '' }} class="sr-only peer">
                                    <div
...
@push('scripts')
    <script>
        ...
        let index = {{$produk->varians->count()}};

        // Variants Management
        function addRow() {
            const row = `
            <tr>
                <td><input type="text" name="varians[${index}][warna]" class="border px-2 py-1 w-full"></td>
                <td><input type="text" name="varians[${index}][size]" class="border px-2 py-1 w-full"></td>
                <td><input type="number" name="varians[${index}][stok]" min="0" class="border px-2 py-1 w-full varian-stok"></td>
                <td><button type="button" class=" w-8 h-8 bg-red-500 text-white" onclick="removeRow(this)">✕</button></td>
            </tr>`;
            document.querySelector('#varianTable tbody').insertAdjacentHTML('beforeend', row);
            index++;
        }
        ...
        function calculateTotal() {
            let total = 0;
            document.querySelectorAll('.varian-stok').forEach(i => {
                total += Number(i.value) || 0;
            });
            document.getElementById('totalVarian').innerText = total;
        }

        document.addEventListener('input', e => {
            if (e.target.classList.contains('varian-stok')) calculateTotal();
        });
