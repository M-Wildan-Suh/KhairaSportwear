        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
            <div class="flex items-center mb-4 md:mb-0">
                ...
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Kode: <span class="text-blue-600 font-medium">{{ $sewa->kode_sewa }}</span>
                    </p>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-white">
                                        {{ $sewa->tanggal_mulai ? $sewa->tanggal_mulai->format('d F Y') : 'Belum ditentukan' }}
                                    </p>
                                </div>
                                <div>
                                    <label class="text-xs font-medium text-white uppercase tracking-wider mb-1 block">
                                    ...
                                    <p class="text-white">
                                        {{ $sewa->tanggal_selesai ? $sewa->tanggal_selesai->format('d F Y') : 'Belum ditentukan' }}
                                    </p>
                                </div>
                            </div>
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <span
                                        class="inline-block px-3 py-1 bg-gray-50 border border-gray-200 rounded-full text-sm">
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-white mt-1 space-y-1">
                                    ...
                                    <p class="flex items-center text-white">
                                        <i
                                            class="fas fa-phone mr-2 text-white"></i>{{ $sewa->user->telepon ?? 'Tidak tersedia' }}
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="border-t border-gray-200 pt-4 mt-6">
                                <div class="flex justify-between items-center mb-2">
                                    ...
                                    <span class="font-semibold text-white">
                                        Rp
                                        {{ number_format($totalHarga > 0 ? $totalHarga : $sewa->total_harga ?? 0, 0, ',', '.') }}
                                    </span>
                                </div>
                                @if ($sewa->denda && $sewa->denda > 0)
                                    ...
                                    <div class="flex justify-between items-center mt-4 pt-4 border-t border-gray-200">
                                        <span class="font-bold text-gray-300">Total Keseluruhan:</span>
                ...
                @if ($sewa->pengembalian && $sewa->pengembalian->status != 'selesai')    
                    {{-- Verifikasi --}}
                    <form action="{{ route('admin.sewa.verif', ['id' => $sewa->pengembalian->id]) }}" method="post">
                        @csrf
                        <div class=" flex justify-end gap-4">
                            @if ($sewa->pengembalian->status != 'selesai')
                            ...
                            @foreach ($statusSteps as $status => $step)
                                <div class="flex items-start mb-6 relative">
                                    <div class="flex-shrink-0 mr-4 relative">
                                        ...
                                        @if (!$loop->last)
                                            <div
                                                class="absolute left-4 top-8 bottom-0 w-0.5 
                                    ...
                                    <div>
                                        <h3
                                            class="font-medium {{ $loop->iteration <= $currentStep + 1 ? 'text-white' : 'text-gray-500' }}">
                                            {{ $step['label'] }}
                                        </h3>
                                        @if ($loop->iteration == 1)
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                        <div class="p-6">
                            ...
                            <div class="text-center">
                                <a href="{{ Storage::url($sewa->bukti_pembayaran) }}" data-lightbox="bukti-pembayaran"
                                    class="inline-block">
                                    <img src="{{ Storage::url($sewa->bukti_pembayaran) }}" alt="Bukti Pembayaran"
                ...
                @if ($sewa->status == 'selesai' && $sewa->tanggal_pengembalian)
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 border-l-4 border-green-500">
                        <div class="p-6">
                            ...
                            <div class="space-y-3">
                                <div>
                                    <label class="text-sm font-medium text-gray-600 mb-1 block">Tanggal
                                        Pengembalian</label>
