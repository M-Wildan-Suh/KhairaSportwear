                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                    ...
                    <div>
                        ...
                        <select name="metode_bayar"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
                            <option value="semua" {{ request('metode_bayar') == 'semua' ? 'selected' : '' }}>Semua Metode
                            </option>
                            <option value="tunai" {{ request('metode_bayar') == 'tunai' ? 'selected' : '' }}>Tunai
                            </option>
                            <option value="transfer" {{ request('metode_bayar') == 'transfer' ? 'selected' : '' }}>Transfer
                            </option>
                            <option value="kartu_kredit" {{ request('metode_bayar') == 'kartu_kredit' ? 'selected' : '' }}>
                                Kartu Kredit</option>
                            <option value="debit" {{ request('metode_bayar') == 'debit' ? 'selected' : '' }}>Debit
                            </option>
                        </select>
                    </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        ...
                        <div class="flex">
                            ...
                            <button type="submit"
                                class="bg-blue-600 text-white px-4 rounded-r-lg hover:bg-blue-700 text-sm">
                                ...
                                @foreach ($transactions as $transaction)
                                    <tr class="hover:bg-gray-500">
                                        ...
                                        <td class="px-3 py-2 whitespace-nowrap">
                                            ...
                                            @if ($transaction->note)
                                                <div class="text-[10px] text-gray-500 truncate max-w-[100px]"
                                                    ...
                                                    <i
                                                        class="fas fa-sticky-note mr-1"></i>{{ Str::limit($transaction->note, 20) }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="px-3 py-2 whitespace-nowrap">
                                        ...
                                        <td class="px-3 py-2 whitespace-nowrap">
                                            ...
                                            @endphp
                                            <span
                                                class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium border {{ $config['color'] }}">
                                            ...
                                            <i class="fas fa-file-invoice text-xs"></i>
                                                ...
                                                @if ($transaction->bukti_bayar)
                                                    <a href="{{ Storage::url($transaction->bukti_bayar) }}"
                                                        target="_blank" class="p-1 text-gray-400 hover:text-orange-600"
